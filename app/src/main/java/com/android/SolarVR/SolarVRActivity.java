...
import static com.android.SolarVR.SolarVRLib.change;
...
public class SolarVRActivity extends Activity implements SensorEventListener {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        //return SolarVRLib.key(keyCode, 1) != 0 ? true : super.onKeyDown(keyCode, event);
        return true;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (mGravity != null && mGeomagnetic != null) {
            ...
            if (success) {
                ...
                ax=(float) orientation[2]; ay=(float) orientation[0];az=(float)-orientation[1];
               // System.out.println("AXE DES XX : " + orientation[2] + "AXE DES YYY:" + orientation[0]);
                SolarVRLib.visee(ax,ay,az);
            }
        }
